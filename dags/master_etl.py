...
def deployment_table_etl(engine):
    deploy_df = DeploymentExt.get_dataframe()
...
def sku_master_table_etl(engine):
    sku_master_df = SkuMasterExt.get_dataframe()
...
def location_table_etl(engine):
    location_df = LocationExt.get_dataframe()
...
def pivotal_size_table_etl(engine):
    pivotal_size_df = PivotalSizeExt.get_dataframe()
...
def seasonality_table_etl(engine):
    seasonality_df = SeasonalityExt.get_dataframe()
